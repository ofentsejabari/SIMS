...
public class Notification extends HBox{
    ...
    public Notification(String message, int type, VBox parent) {
        ...
        Text icon = SIMS.getGraphics(MaterialDesignIcon.LED_VARIANT_ON, "text-success", 24);
        
        
        close = new JFXButton("", SIMS.getGraphics(MaterialDesignIcon.LED_VARIANT_ON, "text-error", 16));

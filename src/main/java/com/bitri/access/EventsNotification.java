...
public class EventsNotification extends JFXPopup{
    ...
    public EventsNotification(Node owner) {
        ...
        HBox hdr = new HBox(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-blue", 32), title);
        hdr.setSpacing(20);
        ...
        for(int i=0;i<=5;i++){
            ...
            Text icon = SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-success", 24);

 ...
 * @author ofentse
 */
public class CustomCheckListView2 extends GridPane{
    
    ListView<String>  source;
    ListView<HBox> target;
    ...
    public CustomCheckListView2() {
        setPadding(new Insets(10, 10, 10, 10));
        setHgap(10);
        setVgap(10);
        
        source = new ListView<>();
        target = new ListView<HBox>();
...
//    }
    ...
    public ListView<HBox> getTarget() {
        return target;
    }
    ...
    public void setTarget(ListView<HBox> target) {
        this.target = target;
    }

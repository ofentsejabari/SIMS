...
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com.bitri.access/view/MainUIFXML.fxml"));
//            Parent root = loader.load();
            //MAIN_CONTROLLER = loader.getController();
            
//            Scene scene = new Scene(root, Color.TRANSPARENT);
//            scene.getStylesheets().add(com.bitri.access.SIMS.class.getResource("css/style.css").toExternalForm());

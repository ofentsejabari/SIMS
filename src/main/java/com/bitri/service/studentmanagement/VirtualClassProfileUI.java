 ...
 * @author ofentse
 */
public class VirtualClassProfileUI extends JFXDialog{
    ...
    public VirtualClassProfileUI(VirtualClass bClass){
        ...
        if(student != null){
            ...
            assignedClass.setText(student.getBatchID());
        ...
        Tab studentProfile = new Tab("Students");
    ...
    public  BorderPane getParentDetails(){
        ...
        btn_edit.setGraphic(SIMS.getGraphics(MaterialDesignIcon.LED_VARIANT_ON, "icon-default", 22));

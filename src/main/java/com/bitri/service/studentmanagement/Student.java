...
public class Student {
    SimpleStringProperty id, studentID, firstName, lastName, middleName, dob,
            batchID, gender, lastSchoolAttended, pslegrade, citizenship, email,
    ...
    public Student(String id, String studentID, String firstName, String lastName, String middleName, 
            String dob, String batchID, String gender, String lastSchool, String psl, String citizenship,
    ...
    public void setBatchID(String mnam){batchID.set(mnam);}

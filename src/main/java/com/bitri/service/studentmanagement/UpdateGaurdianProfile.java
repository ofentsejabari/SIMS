...
public class UpdateGaurdianProfile extends JFXDialog{
    ...
    public UpdateGaurdianProfile(Guardian guardian, String studentID){
        ...
        contentGrid.add(SIMS.setBorderContainer(getParentDetails(), "Persornal Details"), 0, 0);
        contentGrid.add(SIMS.setBorderContainer(getParentContactDetails(), "Contact Details"), 0, 1);
        //----------------------------------------------------------------------
        ...
        save.setOnAction((ActionEvent event) -> {
            ...
            if(guardian != null){ //-- update --
                ...
                if(isValidateInputs()){
                    ...
                    if(SIMS.dbHandler.updateGaurdianProfile(guardian, true)){
                        new DialogUI("Gaurdian details has been updated successfully",
                                    DialogUI.SUCCESS_NOTIF, root, this).show();
                    }else{
                        new DialogUI("An error occured while trying to update gaurdian details.",
                ...
                if(isValidateInputs()){
                    ...
                    if(SIMS.dbHandler.updateGaurdianProfile(parent, false)){
                        new DialogUI("Gaurdian details has been added successfully",
                                    DialogUI.SUCCESS_NOTIF, STUDENT_MAN_STACK, this).show();
                        close();
                    }else{
                        new DialogUI(" An error occured while trying to add gaurdian details.",
                                DialogUI.ERROR_NOTIF, root, null).show();
                    }

 ...
 * @author jabari
 */
public class UpdateBaseClassFinance extends JFXDialog{
    ...
    public UpdateBaseClassFinance(BaseClass base_class, Fee selectedFee) {
        ...
        contentGrid.setStyle("-fx-padding:15 5 15 10;");
        contentGrid.setVgap(10);
        contentGrid.setHgap(2);
        
        reg_date = new JFXDatePicker();
        reg_date.setPromptText("Fee collection date");
        ...
        listviewControls.getStyleClass().add("primary-toolbar");
       ...
       contentGrid.add(listviewControls, 0, 1);
        ...
        Label title = new Label(base_class.getName()+" - "+selectedFee.getName());

...
package com.bitri.service.eventcalendar;
...
public class JBEventCalendar extends BorderPane{
    ...
    private void rollDateTo(Calendar calendar) {
        ...
        JFXButton monthForward = new JFXButton("", SIMS.getGraphics(MaterialDesignIcon.CHEVRON_RIGHT, "text-indigo", 24));
...
//            elws.restart();
        ...
        JFXButton monthBack = new JFXButton("", SIMS.getGraphics(MaterialDesignIcon.CHEVRON_LEFT, "text-indigo", 24));

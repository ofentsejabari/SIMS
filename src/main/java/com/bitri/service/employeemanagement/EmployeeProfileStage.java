...
public class EmployeeProfileStage extends JFXDialog{
    ...
    public EmployeeProfileStage(EmployeeModel  emp){
        ...
        enrollDate.setPromptText("Employment Date");
    ...
    public  BorderPane getNextOfKinDetails(EmployeeModel emp){
        ...
        btn_edit.setGraphic(SIMS.getGraphics(MaterialDesignIcon.UPLOAD, "icon-default", 22));
        btn_edit.setOnAction((ActionEvent event) -> {
            new UpdateEmployeeStage(emp);
        });
        ...
        VBox con = new VBox(SIMS.setBorderContainer(empDetails, "Personal Details"),

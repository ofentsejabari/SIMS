...
import static com.bitri.service.inventorymanagement.control.InventoryListController.inventList;
    ...
    public class InventoryListWork extends Task<ObservableList<Inventory>> {       
        ...
        protected ObservableList<Inventory> call() throws Exception {
            ...
            Platform.runLater(() -> {  
                ...
                inventoryTable.getTableView().setPlaceholder(SIMS.setDataNotAvailablePlaceholder());
            });

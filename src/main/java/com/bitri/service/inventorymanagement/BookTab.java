...
public class BookTab extends BorderPane{
 ...
 public BookTab(){
            ...
            */
            ...
            addDept.setGraphic(SIMS.getGraphics(MaterialDesignIcon.LED_VARIANT_ON, "icon-default", 24));
            ...
            filterDept.setGraphic(SIMS.getGraphics(MaterialDesignIcon.LED_VARIANT_ON, "icon-default", 18));

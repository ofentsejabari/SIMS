...
public class SupplierInformationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       activateButtons(false);
        searchIcon.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "icon-default", 17));
        searchButton.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "icon-default", 17));
        ...
        btn_edit.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "icon-default", 24));

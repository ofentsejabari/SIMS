...
import static com.bitri.resource.dao.InventoryQuery.getResourceId;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //            btn_cancel.setDisable(true);
                    ...
                    new DialogUI("Facilities resource has been added successfully",
                        DialogUI.SUCCESS_NOTIF, SIMS.MAIN_UI ,null).show();

                }
                else{
                    new DialogUI("Exception occurred while trying to add Facilities resource",
                        DialogUI.ERROR_NOTIF, SIMS.MAIN_UI , null).show();
                }

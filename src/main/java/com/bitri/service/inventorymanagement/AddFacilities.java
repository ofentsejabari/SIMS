...
import com.bitri.service.inventorymanagement.control.AddFacilitiesController;
...
public class AddFacilities  extends JFXDialog{
    ...
    public AddFacilities(){
        try{
            FXMLLoader ui = new FXMLLoader(getClass().getResource("/views/inventorymanagementViews/addFacilities.fxml"));

...
import com.bitri.service.inventorymanagement.control.FacilityStatusController;
...
public class FacilityStatus  extends JFXDialog{
    ...
    public FacilityStatus(String facility_name){
        try{
            FXMLLoader ui = new FXMLLoader(getClass().getResource("/views/inventorymanagementViews/facilityStatus.fxml"));

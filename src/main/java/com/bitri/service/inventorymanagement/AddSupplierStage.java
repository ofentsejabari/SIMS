...
import com.bitri.service.inventorymanagement.control.AddSupplierController;
...
public class AddSupplierStage  extends JFXDialog{
    ...
    public AddSupplierStage(){
        try{
            FXMLLoader ui = new FXMLLoader(getClass().getResource("/views/inventorymanagementViews/addSupplier.fxml"));

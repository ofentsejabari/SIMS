...
import static com.bitri.service.inventorymanagement.control.FacilitiesController.facilitiesList;
    ...
    public class FacilitiesWork extends Task<ObservableList<Facilities>> {       
        ...
        protected ObservableList<Facilities> call() throws Exception {
            ...
            Platform.runLater(() -> {  
                ...
                facilitiesTable.getTableView().setPlaceholder(SIMS.setDataNotAvailablePlaceholder());
            });

...
public class AcademicTermController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_add.setGraphic(SIMS.getGraphics(MaterialDesignIcon.FILE_EXPORT, "icon-default", 24));
        btn_add.setOnAction((ActionEvent event) -> {
            
        });
        
        btn_export.setGraphic(SIMS.getGraphics(MaterialDesignIcon.FILE_EXPORT, "icon-default", 24));
        btn_export.setOnAction((ActionEvent event) -> {
            //new ExportMenu(btn_export);
        });
        
        
        btn_refresh.setGraphic(SIMS.getGraphics(MaterialDesignIcon.FILE_EXPORT, "icon-default", 24));
...
//                            }
        ...
        VBox ph = SIMS.setDataNotAvailablePlaceholder(termListWork);
    ...
    public class TermListWork extends Task<ObservableList<Term>> {       
        ...
        protected ObservableList<Term> call() throws Exception {
            ...
            ObservableList<Term> termList = AdminQuery.getTermList();

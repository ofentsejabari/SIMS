...
public class SchoolBasicInfo extends BorderPane{
    ...
    public SchoolBasicInfo(){
        ...
        btn_add.setOnAction((ActionEvent event) -> {
            new UpdateSchoolDialog(SIMS.dbHandler.getSchoolByID());
        });
...
//        contentGrid.add(com.bitri.access.SIMS.setBorderContainer(basicInfo, null), 0, 0);
        ...
        schoolLogo = SIMS.getIcon("information.png", 100);
        logo.add(schoolLogo, 0, 1);
        
        //contentGrid.add(com.bitri.access.SIMS.setBorderContainer(logo, null), 1, 0);
        
        VBox n1 = SIMS.setBorderContainer(logo, null);
        HBox.setHgrow(n1, Priority.ALWAYS);
        //logo.setStyle("-fx-border-color:red;");
        
        VBox n2 = SIMS.setBorderContainer(basicInfo, null);
    ...
    public class SchoolInfoWork extends Task<Integer> {       
        ...
        protected Integer call() throws Exception {
            ...
            Platform.runLater(() -> {
                School school = SIMS.dbHandler.getSchoolByID();

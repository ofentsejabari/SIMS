package com.bitri.service.messanger;
...
import com.bitri.service.messanger.control.ChatsController;
import com.bitri.service.messanger.control.ListItemController;
    ...
    public MessangerManagement() {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                ...
                //-- 
                FXMLLoader listItemloader = new FXMLLoader(SIMS.class.getResource("/com/bitri/service/messanger/view/listItem.fxml"));
                ...
                //-- 
                FXMLLoader chatLoader = new FXMLLoader(SIMS.class.getResource("/com/bitri/service/messanger/view/chat.fxml"));

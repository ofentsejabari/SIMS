package com.bitri.service.messanger.control;
...
public class ChatsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_refresh.setText("");
        btn_refresh.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-secondary", 18));
        
        btn_add.setText("");
        btn_add.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-secondary", 18));
        
        btn_remove.setText("");
        btn_remove.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-secondary", 18));
        
        btn_exit_group.setText("");
        btn_exit_group.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-secondary", 18));
        
        send.setText("");
        send.setGraphic(SIMS.getGraphics(MaterialDesignIcon.ROTATE_3D, "text-white", 18));
